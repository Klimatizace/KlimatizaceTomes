// Simple static form page to verify Netlify form detection without JS/AJAX.
// Visit /form-test after deploy, submit, and check Netlify dashboard.
export const metadata = { title: 'Test Form' };

export default function FormTestPage() {
  return (
    <main className="mx-auto max-w-md px-6 py-16">
      <h1 className="mb-4 text-2xl font-bold">Test Form (Netlify)</h1>
